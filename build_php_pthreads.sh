#Instalación de apache mysql y php con pthreads sobre debian 7 32bit
...
wget http://cl1.php.net/get/php-5.5.29.tar.gz/from/this/mirror -O php-5.5.29.tar.gz
...
cp -a pthreads-2.0.10/. php-5.5.29/ext/pthreads/
